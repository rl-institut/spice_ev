...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="Specify the charging strategy. One of {}. You may define \
                        custom options with --strategy-option.".format(
            ", ".join(STRATEGIES)
        ),
    )
    parser.add_argument(
        ...
        default=0.05,
        help=(
            "Add margin for desired SOC [0.0 - 1.0].\
    ...
    parser.add_argument(
        "--visual", "-v", action="store_true", help="Show plots of the results"
    )
    parser.add_argument(
        "--eta",
        action="store_true",
    ...
    parser.add_argument(
        "--output", "-o", help="Deprecated, use save-timeseries instead"
    )
    ...
    if args.output:
        warnings.warn(
            "output argument is deprecated, use save-timeseries instead",
            DeprecationWarning,
        )
